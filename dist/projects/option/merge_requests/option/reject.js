...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/actions/projects/option/merge_requests/option/reject.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./src/actions/projects/option/merge_requests/option/reject.ts":
/*!*********************************************************************!*\
  !*** ./src/actions/projects/option/merge_requests/option/reject.ts ***!
  \*********************************************************************/
...
"use strict";
eval("\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\n// eslint-disable-next-line camelcase\r\nvar api_1 = __webpack_require__(/*! ../../../../../utils/api */ \"./src/utils/api.ts\");\r\nvar helper_1 = __webpack_require__(/*! ../../../../../utils/helper */ \"./src/utils/helper.ts\");\r\nif ((options === null || options === void 0 ? void 0 : options.projects) && (options === null || options === void 0 ? void 0 : options.merge_requests)) {\r\n    var _a = options.projects, projectId = _a.id, html_url = _a.html_url, projectName = _a.name;\r\n    var id = options.merge_requests.id;\r\n    var response = api_1.deleteMR(projectId, id);\r\n    var result = helper_1.decodeApiResponse(response);\r\n    if (result.status >= 400) {\r\n        open(html_url);\r\n        helper_1.handleErrors(result.status, result.response.message);\r\n    }\r\n    else {\r\n        notify('Merge Request Deleted', 'success', 3000);\r\n        reIndex(['gitlab', 'projects', projectName, 'merge_requests']);\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack://main/./src/actions/projects/option/merge_requests/option/reject.ts?");
