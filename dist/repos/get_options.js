...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/actions/repos/get_options.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./src/actions/repos/get_options.ts":
/*!******************************************!*\
  !*** ./src/actions/repos/get_options.ts ***!
  \******************************************/
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\n/* eslint-disable consistent-return */\nvar api_1 = __webpack_require__(/*! ../../utils/api */ \"./src/utils/api.ts\");\nvar helper_1 = __webpack_require__(/*! ../../utils/helper */ \"./src/utils/helper.ts\");\nexports.default = (function () {\n    var userData = api_1.getUserInfo();\n    var user = helper_1.decodeApiResponse(userData).response;\n    var response = api_1.getAllProjects(user.id);\n    var result = helper_1.decodeApiResponse(response);\n    if (result.status >= 400) {\n        return {};\n    }\n    var repos = result.response.map(function (project) { return ({\n        name: project.name,\n        html_url: project.web_url,\n        id: project.id,\n        identifier: project.id,\n    }); });\n    return JSON.stringify({\n        add: repos,\n    });\n});\n\n\n//# sourceURL=webpack://main/./src/actions/repos/get_options.ts?");
