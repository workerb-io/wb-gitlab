...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/actions/repos/option/branches/option/new_mr.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./src/actions/repos/option/branches/option/new_mr.ts":
/*!************************************************************!*\
  !*** ./src/actions/repos/option/branches/option/new_mr.ts ***!
  \************************************************************/
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar api_1 = __webpack_require__(/*! ../../../../../utils/api */ \"./src/utils/api.ts\");\nvar helper_1 = __webpack_require__(/*! ../../../../../utils/helper */ \"./src/utils/helper.ts\");\nif ((options === null || options === void 0 ? void 0 : options.repos) && (options === null || options === void 0 ? void 0 : options.branches)) {\n    var _a = options.repos, id = _a.id, projectName = _a.name;\n    var sourceBranchName = options.branches.name;\n    var mrPayload = args.filter(Boolean).join(' ');\n    if (!mrPayload) {\n        mrPayload = prompt('Enter branch name');\n    }\n    var mrPayloadArgs = mrPayload.split(' ');\n    var refIndex = mrPayloadArgs.indexOf('ref');\n    var targetBranchName = refIndex !== -1 ? mrPayloadArgs.slice(refIndex + 1).join(' ') : 'master';\n    var mrName = refIndex === -1 ? mrPayload : mrPayloadArgs.slice(0, refIndex).join(' ');\n    if (sourceBranchName === targetBranchName) {\n        notify('Source Branch and Target branch are same', 'success', 3000);\n    }\n    else {\n        var response = api_1.createNewMR(id, {\n            source_branch: sourceBranchName,\n            target_branch: targetBranchName,\n            title: mrName,\n        });\n        var result = helper_1.decodeApiResponse(response);\n        if (result.status >= 400) {\n            helper_1.handleErrors(result.status, result.response.message);\n        }\n        else {\n            notify('Merge request created', 'success', 3000);\n            open(result.response.web_url);\n            reIndex(['gitlab', 'repos', projectName, 'branches']);\n        }\n    }\n}\n\n\n//# sourceURL=webpack://main/./src/actions/repos/option/branches/option/new_mr.ts?");
